...
const STRINGS = {
  en: {
    ...
    /* The three steps, and the two things that moved below them. */
    'exec.step.command': 'The command',
    'exec.step.send': 'Send it to the device',
    'exec.pick': 'Pick a command',
  ...
  pt: {
    ...
    /* Os três passos, e as duas coisas que desceram para baixo deles. */
    'exec.step.command': 'O comando',
    'exec.step.send': 'Enviar ao aparelho',
    'exec.pick': 'Escolher um comando',
