...
--
-- The file number is this suite's, not the migration's: every other assertions
-- file happens to match the migration it covers, and this one does not, because
-- v18 is reserved by another change landing in the same series. Somebody
-- looking for 00018's proof should read this file; the line above is the only
-- thing that will tell them so.
--
