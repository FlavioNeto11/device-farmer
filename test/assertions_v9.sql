-- Assertions for migration 00009: authorisation on lease re-attach.
--
...
--
-- Run:  psql -v ON_ERROR_STOP=1 -f test/assertions_v9.sql
...
BEGIN
  ...
  RAISE NOTICE '--------------------------------------------------';
  RAISE NOTICE 'ALL v9 ASSERTIONS PASSED';
END $$;
