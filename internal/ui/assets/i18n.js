...
const STRINGS = {
  en: {
    ...
    'recovery.blastWord': 'blast radius',
    'recovery.policyWord': 'disruption policy',
    ...
    'quarantine.unknownScope': 'unknown scope',
    ...
    'bulk.form.what': 'What to run',
    'bulk.form.where': 'Where it lands',
    ...
    'bulk.form.limitsNote': 'Devices at once, per hub. Max per hub keeps a fleet-wide command from browning out one power domain.',
  ...
  pt: {
    ...
    'recovery.blastWord': 'raio de impacto',
    'recovery.policyWord': 'política de perturbação',
    ...
    'quarantine.unknownScope': 'escopo desconhecido',
    ...
    'bulk.form.what': 'O que rodar',
    'bulk.form.where': 'Onde isso cai',
    'bulk.form.command': 'Comando',
    'bulk.form.commandHelp': 'Enviado a cada dispositivo correspondente exatamente como digitado. O shell do próprio aparelho faz a separação de palavras, e o construtor acima define quanto tempo cada dispositivo recebe.',
    ...
    'bulk.form.limitsNote': 'Dispositivos ao mesmo tempo, por hub. O máximo por hub evita que um comando na frota inteira derrube a energia de um domínio.',
